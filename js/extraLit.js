		...
		activeSide.forEach(activePiece => {
			...
			if (!pinnedPieces.includes(activePiece)) {
				...
				if (activePiece.getAttribute('data-name') !== 'king') {
					...
					function blockOrEatKingAttacker(somePiece, someId) {
...
>>>>>>> 4f51046d85b0b61a72d22ff4590b0d8120e59394
								});
							});
						}
					}
