...
let whites = [
    { name: 'pawn', x: "0", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "1", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "2", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "3", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "4", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "5", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "6", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'pawn', x: "7", y: "6", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },

    { name: 'knight', x: "1", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'knight', x: "6", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },

    { name: 'bishop', x: "2", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'bishop', x: "5", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },

    { name: 'rook', x: "0", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },
    { name: 'rook', x: "7", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },

    { name: 'queen', x: "3", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' },

    { name: 'king', x: "4", y: "7", image: 'https://github.com/lemokh/Photos/blob/master/whitePawn.png?raw=true' }
];
